        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          <BackgroundGradient className="p-6 bg-zinc-900 rounded-xl h-full">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                Will contribute to secure, large-scale defense applications with
                a focus on performance, security, and reliability.
              </li>
              <li>
                Expected to work in a classified, safety-critical environment
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          <BackgroundGradient className="p-6 bg-zinc-900 rounded-xl h-full">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                Scripts and Power Automate, reducing manual steps by 90%.
              </li>
              <li>
          ...
          <BackgroundGradient className="p-6 bg-zinc-900 rounded-xl h-full">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                Automated Excel-based healthcare reporting using Python,
                reducing repetitive work by 90%.
              </li>
              <li>
